...
// language
var instructions_general1_nl = 'LANGUAGE MANIPULATION INSTRUCTION.';
var instructions_general1_en = 'LANGUAGE MANIPULATION INSTRUCTION.';

// manipulations
var instructions_general2_nl = 'Zoals we al eerder noemden, zijn we bij dit onderzoek geïnteresseerd in hoe we onderscheid kunnen maken tussen mensen die liegen over hun weekendplannen en mensen die hier de waarheid over vertellen. <br><br>We vergelijken hierbij activiteiten die plaatsvonden in het afgelopen weekend met activiteiten die gepland staan voor komend weekend. De ene helft van de deelnemers wordt straks gevraagd om de waarheid te vertellen over hun weekendplannen. De andere helft vragen we om hierover te liegen. Om vervolgens een goede vergelijking te kunnen maken tussen de twee groepen deelnemers, is het belangrijk dat we eerst van iedereen zeker weten wat ze <i>echt</i> voor weekendplannen hebben. <br><br>Klik op de pijl om door te gaan.';
var instructions_general2_en = 'ENGLISH!!!! Zoals we al eerder noemden, zijn we bij dit onderzoek geïnteresseerd in hoe we onderscheid kunnen maken tussen mensen die liegen over hun weekendplannen en mensen die hier de waarheid over vertellen. <br><br>We vergelijken hierbij activiteiten die plaatsvonden in het afgelopen weekend met activiteiten die gepland staan voor komend weekend. De ene helft van de deelnemers wordt straks gevraagd om de waarheid te vertellen over hun weekendplannen. De andere helft vragen we om hierover te liegen. Om vervolgens een goede vergelijking te kunnen maken tussen de twee groepen deelnemers, is het belangrijk dat we eerst van iedereen zeker weten wat ze <i>echt</i> voor weekendplannen hebben. <br><br>Klik op de pijl om door te gaan.';
...
var slider_text_nextweekend_do_nl = 'Geef nu aan voor [OPTIE WEL DOEN IN KOMEND WEEKEND] hoe vaak je deze activiteit in het verleden al hebt gedaan.<br><br>Geef ook aan hoe zeker het is dat je deze activiteit echt gaat doen komend weekend en hoe goed je deze activiteit op dit moment al hebt gepland.';
...
var slider_text_nextweekend_notdo_nl = 'Geef nu aan voor [OPTIE NIET DOEN IN KOMEND WEEKEND] hoe vaak je deze activiteit in het verleden <i>wel</i> hebt gedaan.<br><br>Geef ook aan hoe zeker het is dat je deze activiteit echt niet gaat doen komend weekend.';
...
var instructions_deceptive1_en = 'ENGLISH!!!!! Je wordt nu gevraagd om een verhaal te schrijven over de activiteit van afgelopen weekend en een verhaal over de activiteit van komend weekend. Het is de bedoeling dat je hier over <i>liegt</i>. De activiteit waar je over gaat liegen is gegeven. Jij bedenkt dus het verhaal om deze activiteit heen. Probeer hierbij zo gedetailleerd en plausibel mogelijk te zijn.<br><br>Klik op de pijl om door te gaan';
// + repeat choice!
var instructions_truthful1_en = 'ENGLISH!!! Je wordt nu gevraagd om een verhaal te schrijven over de activiteit van afgelopen weekend en een verhaal over de activiteit van komend weekend. Het is de bedoeling dat je hier <i>de waarheid</i> over vertelt. Beschrijf hierbij de activiteit waarvan je net hebt aangegeven die te gaan doen of die je hebt gedaan. Probeer hierbij zo gedetailleerd en plausibel mogelijk te zijn.';
// + repeat choice!
